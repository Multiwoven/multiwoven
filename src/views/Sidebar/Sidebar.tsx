...
const Sidebar = (): JSX.Element => {
  return (
    <Flex
      ...
      minW="240px" borderColor="#e0e0e0" borderStyle="solid" as="section" minH="100vh" bg="bg.canvas"
    >
      <Flex flex="1" bg="bg.surface" boxShadow="sm" maxW={{ base: 'full', sm: 'xs' }} py={{ base: '6', sm: '8' }} px={{ base: '4', sm: '6' }} >
