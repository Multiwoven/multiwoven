  ...
  return (
    ...
    <>
      <Container w='230px' display='flex' margin={0} padding={0} flexDir='row' className='flex flex-col align-center justify-center'>
        <Box padding={4} width={'100%'} bg='white' minH={'100vh'} color='black' borderRight={'1px'} borderRightColor={'border'}>
          <Button padding={3} pt={5} pb={5} position={'relative'} w={'100%'} onClick={() => handleWorkPlace()}>
            ...
            {logoutPop && <Box fontWeight={'normal'} borderRadius={6} background={'white'} position={'absolute'} top={42} left={0} padding={4} pt={5} pb={5} border={'1px'} borderColor={'border'} width={'100%'}>
