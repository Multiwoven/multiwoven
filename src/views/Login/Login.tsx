...
import { Box, Stack, HStack, FormLabel,  Button, FormControl, Input, Image, Heading, Text, Link, Container, Flex, Spacer, Checkbox } from '@chakra-ui/react';
    ...
    return (
        ...
        <Stack spacing="8">
          <Stack spacing="6" display={'flex'} alignItems={'center'} >
            <img src={MultiwovenIcon} width={70} />
