...
import { Box, Flex, FormControl, FormLabel, Input, Select, Stack, Text, Textarea, VStack } from "@chakra-ui/react";
                        ...
                        <Form>
                            <VStack spacing={5}>
                                <FormControl>
                                    ...
                                    <Field as={Input} id='modelName' name='modelName' placeholder='Enter a name' bgColor='white' />
                                ...
                                <FormControl>
                                    ...
                                    <Field as={Textarea} id='description' name='description' placeholder='Enter a description' bgColor='white' />
                                </FormControl>
                                <FormControl>
                                    <FormLabel htmlFor='primaryKey' fontSize='sm' fontWeight='bold'>Primary Key</FormLabel>
                                    <Field as={Select} placeholder='Select Primary Key' name='primaryKey' bgColor='white' w='lg'>
