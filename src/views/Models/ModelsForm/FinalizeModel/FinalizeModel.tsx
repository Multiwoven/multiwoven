...
const FinalizeModel = (): JSX.Element => {
  ...
  const defineModelData = extractDataByKey<ModelConfig>(
    state.forms,
    "defineModel"
  );
  ...
  async function handleModelSubmit(values: FinalizeForm) {
    try {
      const payload: CreateModelPayload = {
        model: {
          connector_id: defineModelData?.id,
          name: values.modelName,
          description: values.description,
          query: defineModelData?.query,
          query_type: defineModelData?.query_type,
