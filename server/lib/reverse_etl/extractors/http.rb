  ...
  module Extractors
    class Http < Base
      ...
      def read(sync_run_id, activity)
        ...
        skipped_rows = sync_run.skipped_rows || 0
        ...
        if batch_query_params[:sync_config].increment_strategy_config.increment_strategy == "page"
          ReverseEtl::Utils::Paginator.execute_in_batches(batch_query_params) do |records, current_offset|
        ...
        elsif batch_query_params[:sync_config].increment_strategy_config.increment_strategy == "offset"
          ...
          raise StandardError, "Invalid increment strategy"
        end
