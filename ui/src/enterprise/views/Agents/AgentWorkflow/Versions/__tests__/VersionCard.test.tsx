...
jest.mock('@/enterprise/components/Versions/VersionActionsMenu', () => ({
  __esModule: true,
  default: ({
    canDelete,
    onEditDescription,
    ...
    <div data-testid='version-actions-menu' data-can-delete={canDelete}>
...
describe('VersionCard', () => {
  ...
  describe('Preview Button', () => {
    it('should render preview button with data-testid workflow-version-preview-button', () => {
      renderComponent(createMockVersion(), false);
      expect(screen.getByTestId('workflow-version-preview-button')).toBeInTheDocument();
    });
  ...
  describe('Actions Menu', () => {
    it('should pass canDelete=false to VersionActionsMenu when status is live', () => {
      renderComponent(createMockVersion({ workflow_status: 'published' }), false, true);
    ...
    it('should pass canDelete=true to VersionActionsMenu when status is not live', () => {
      renderComponent(createMockVersion({ workflow_status: 'draft' }), false);
      expect(screen.getByTestId('version-actions-menu')).toHaveAttribute('data-can-delete', 'true');
    });

    it('should pass canDelete=false to VersionActionsMenu when isCurrent is true', () => {
      renderComponent(createMockVersion(), true);
      expect(screen.getByTestId('version-actions-menu')).toHaveAttribute(
        'data-can-delete',
        'false',
