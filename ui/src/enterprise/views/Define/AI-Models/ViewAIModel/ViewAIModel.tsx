...
const ViewAIModel = () => {
  ...
  const {
    data: aiSourceCatalog,
    isLoading: aiSourceCatalogIsLoading,
    refetch: refetchAiSourceCatalog,
  } = useQuery({
    ...
    <Box width='100%' display='flex' justifyContent='center'>
      <ContentContainer>
        <TopBar
          ...
          nameTooltip={aiModelData.data.attributes.description}
          nameTooltipVisible={true}
        ...
        >
          ...
          <Box>
            <form onSubmit={(e) => handleOnUpdate(e, undefined, true)}>
              <MapHarvest
